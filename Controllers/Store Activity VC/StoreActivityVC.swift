...
class StoreActivityVC: UIViewController {

    @IBOutlet var storeActivityTable: UITableView!
...
extension StoreActivityVC:UITableViewDelegate,UITableViewDataSource
{
